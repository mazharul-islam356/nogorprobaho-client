        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {sections.map((section, idx) => {
            ...
            return (
              <div key={idx}>
                {/* SECTION HEADER */}
                <div className="border-b-2 border-red-600 mb-4 pb-2">
                ...
                {mainNews && (
                  <Link href={`/news/${mainNews?._id || "#"}`}>
                    <article className="group bg-white border border-gray-200 overflow-hidden hover:shadow-lg transition mb-4 flex flex-col">
                      ...
                      <div className="p-4">
                        <h3 className="text-lg font-bold line-clamp-1 group-hover:text-red-600 transition mb-2 ">
                    ...
                    <Link key={i} href={`/news/${news?._id || "#"}`}>
                      <article className="group flex gap-3 bg-white border border-gray-200 p-3 hover:shadow-lg transition">
                        ...
                        <div className="flex-1">
                          <h4 className="text-sm font-medium line-clamp-2 group-hover:text-red-600 transition mb-1">
