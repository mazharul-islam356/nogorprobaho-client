                ...
                <Link key={news?._id} href={`/news/${news?._id}`}>
                  <article className="group flex gap-4 border-b border-gray-200 pb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-[18px] leading-7 font-bold text-[#111] line-clamp-2 group-hover:text-red-600 transition">
              ...
              {rightGrid.map((news) => (
                <Link key={news?._id} href={`/news/${news?._id}`}>
                  <article className="group">
                    ...
                    {/* CONTENT */}
                    <div className="pt-3">
                      <h4 className="text-[14px] md:text-[16px] leading-6 font-semibold text-[#111] line-clamp-3 group-hover:text-red-600 transition">
                        {getTranslatedValue(news?.title, lang)}
                      </h4>
