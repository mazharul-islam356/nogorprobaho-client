              ...
              <Link href={`/news/${featuredNews?._id}`}>
                <article className="group grid grid-cols-1 md:grid-cols-2 items-stretch">
                  ...
                  <div className="pt-5 md:p-8 flex flex-col justify-center order-2 md:order-1">
                    <span className="text-[#57832A] text-sm font-semibold">
                      {getTranslatedValue(featuredNews?.category, lang)}
                    </span>

                    <h2 className="mt-3 text-[26px] md:text-[40px] leading-[1.2] font-bold text-[#222] line-clamp-3 group-hover:text-[#57832A] transition">
              ...
              <Link key={item?._id} href={`/news/${item?._id}`}>
                <article className="group p-5 flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="md:text-[22px] text-md leading-[1.5] font-semibold text-[#222] line-clamp-3 group-hover:text-[#57832A] transition">
          ...
          {bottomNews.map((item) => (
            <Link key={item?._id} href={`/news/${item?._id}`}>
              <article className="group">
                ...
                {/* CONTENT */}
                <div className="pt-4">
                  <h3 className="text-[20px] md:text-[24px] leading-[1.5] font-semibold text-[#222] line-clamp-3 group-hover:text-[#57832A] transition">
                    {getTranslatedValue(item?.title, lang)}
                  </h3>
